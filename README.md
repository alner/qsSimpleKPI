...
Download [build/qsSimpleKPI.zip](https://github.com/alner/qsSimpleKPI/blob/master/build/qsSimpleKPI.zip), upload to qlik server or extract to appropriate folder.
